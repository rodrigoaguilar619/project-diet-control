...
public class ReportDietCustomBusiness {
	...
	@Transactional
	public GetDietCustomReportRespPojo executeGetDietCustomReport(GetDietCustomReportRequestPojo requestPojo) throws FileNotFoundException, JRException {
		...
		GetDietCustomReportRespPojo responsePojo = new GetDietCustomReportRespPojo();
